      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <h5 className="font-bold">{t("footer_contact")}</h5>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              {/* GitHub */}
              <a
                href="https://github.com/DevWizard82"
                target="_blank"
                rel="noopener noreferrer"
                title="GitHub"
                className="w-10 h-10 rounded-full bg-background-light border border-slate-200 flex items-center justify-center hover:bg-primary hover:text-white transition-all"
              >
                <svg
              ...
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/anas-berrqia-37b653346/"
                target="_blank"
                rel="noopener noreferrer"
                title="LinkedIn"
                className="w-10 h-10 rounded-full bg-background-light border border-slate-200 flex items-center justify-center hover:bg-primary hover:text-white transition-all"
